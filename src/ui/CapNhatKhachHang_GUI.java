...
public class CapNhatKhachHang_GUI extends JFrame implements ItemListener, WindowListener {
	...
	public CapNhatKhachHang_GUI(KhachHang khachHang) {
		...
		DefaultLayout defaultLayout = new DefaultLayout(this, contentPane, "Cập nhật khách hàng",
				"Cập nhật khách hàng");
	...
	public void itemStateChanged(ItemEvent e) {
		...
		if (cmbTinh.equals(object)) {
			...
			CapNhatKhachHang_GUI.this.phuong = phuong;
			isEnabledEventPhuong = false;
		}
