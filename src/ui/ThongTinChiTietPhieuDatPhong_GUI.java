...
//		});
	...
	private void setPhieuDatPhongVaoForm(ChiTietDatPhong chiTietDatPhong) {
		...
		txtTGLP.setText(Utils.convertLocalTimeToString(datPhong_DAO.getDatPhong(maDatPhong).getGioDatPhong()) + " - " + Utils.formatDate(datPhong_DAO.getDatPhong(maDatPhong).getNgayDatPhong()));
		txtTGNP.setText(Utils.convertLocalTimeToString(datPhong_DAO.getDatPhong(maDatPhong).getGioNhanPhong()) + " - " + Utils.formatDate(datPhong_DAO.getDatPhong(maDatPhong).getNgayNhanPhong()));
	}
